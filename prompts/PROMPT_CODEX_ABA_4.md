...
### LOTE 1 (lote_t_117)
1. Leia C:/winegod-app/lotes_codex/lote_t_117.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_117.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 2 (lote_t_118)
1. Leia C:/winegod-app/lotes_codex/lote_t_118.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_118.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 3 (lote_t_119)
1. Leia C:/winegod-app/lotes_codex/lote_t_119.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_119.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 4 (lote_t_120)
1. Leia C:/winegod-app/lotes_codex/lote_t_120.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_120.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 5 (lote_t_121)
1. Leia C:/winegod-app/lotes_codex/lote_t_121.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_121.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
