...
### LOTE 1 (z_007)
1. Leia C:/winegod-app/lotes_codex/lote_z_007.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_007.txt

### LOTE 2 (z_008)
1. Leia C:/winegod-app/lotes_codex/lote_z_008.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_008.txt

### LOTE 3 (z_009)
1. Leia C:/winegod-app/lotes_codex/lote_z_009.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_009.txt

### LOTE 4 (z_010)
1. Leia C:/winegod-app/lotes_codex/lote_z_010.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_010.txt

### LOTE 5 (z_011)
1. Leia C:/winegod-app/lotes_codex/lote_z_011.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_011.txt
