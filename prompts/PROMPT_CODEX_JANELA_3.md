...
### LOTE 1 (z_017)
1. Leia C:/winegod-app/lotes_codex/lote_z_017.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_017.txt

### LOTE 2 (z_018)
1. Leia C:/winegod-app/lotes_codex/lote_z_018.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_018.txt

### LOTE 3 (z_019)
1. Leia C:/winegod-app/lotes_codex/lote_z_019.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_019.txt

### LOTE 4 (z_020)
1. Leia C:/winegod-app/lotes_codex/lote_z_020.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_020.txt

### LOTE 5 (z_021)
1. Leia C:/winegod-app/lotes_codex/lote_z_021.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_021.txt
