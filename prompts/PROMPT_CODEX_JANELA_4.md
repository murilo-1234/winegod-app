...
### LOTE 1 (z_022)
1. Leia C:/winegod-app/lotes_codex/lote_z_022.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_022.txt

### LOTE 2 (z_023)
1. Leia C:/winegod-app/lotes_codex/lote_z_023.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_023.txt

### LOTE 3 (z_024)
1. Leia C:/winegod-app/lotes_codex/lote_z_024.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_024.txt

### LOTE 4 (z_025)
1. Leia C:/winegod-app/lotes_codex/lote_z_025.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_025.txt

### LOTE 5 (z_026)
1. Leia C:/winegod-app/lotes_codex/lote_z_026.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_026.txt
