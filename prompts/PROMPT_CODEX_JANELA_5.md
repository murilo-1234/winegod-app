...
### LOTE 1 (z_027)
1. Leia C:/winegod-app/lotes_codex/lote_z_027.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_027.txt

### LOTE 2 (z_028)
1. Leia C:/winegod-app/lotes_codex/lote_z_028.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_028.txt

### LOTE 3 (z_029)
1. Leia C:/winegod-app/lotes_codex/lote_z_029.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_029.txt

### LOTE 4 (z_030)
1. Leia C:/winegod-app/lotes_codex/lote_z_030.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_030.txt

### LOTE 5 (z_031)
1. Leia C:/winegod-app/lotes_codex/lote_z_031.txt (os itens numerados DENTRO deste arquivo)
2. Classifique ESSES itens do ZERO em 4 blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_z_031.txt
