...
### LOTE 1 (lote_t_360)
1. Leia C:/winegod-app/lotes_codex/lote_t_360.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_360.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 2 (lote_t_361)
1. Leia C:/winegod-app/lotes_codex/lote_t_361.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_361.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 3 (lote_t_362)
1. Leia C:/winegod-app/lotes_codex/lote_t_362.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_362.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 4 (lote_t_363)
1. Leia C:/winegod-app/lotes_codex/lote_t_363.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_363.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 5 (lote_t_364)
1. Leia C:/winegod-app/lotes_codex/lote_t_364.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_364.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 6 (lote_t_365)
1. Leia C:/winegod-app/lotes_codex/lote_t_365.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_365.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 7 (lote_t_366)
1. Leia C:/winegod-app/lotes_codex/lote_t_366.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_366.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 8 (lote_t_367)
1. Leia C:/winegod-app/lotes_codex/lote_t_367.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_367.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 9 (lote_t_368)
1. Leia C:/winegod-app/lotes_codex/lote_t_368.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_368.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 10 (lote_t_369)
1. Leia C:/winegod-app/lotes_codex/lote_t_369.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_369.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
