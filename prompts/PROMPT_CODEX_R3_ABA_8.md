...
### LOTE 1 (lote_t_370)
1. Leia C:/winegod-app/lotes_codex/lote_t_370.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_370.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 2 (lote_t_371)
1. Leia C:/winegod-app/lotes_codex/lote_t_371.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_371.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 3 (lote_t_372)
1. Leia C:/winegod-app/lotes_codex/lote_t_372.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_372.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 4 (lote_t_373)
1. Leia C:/winegod-app/lotes_codex/lote_t_373.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_373.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 5 (lote_t_374)
1. Leia C:/winegod-app/lotes_codex/lote_t_374.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_374.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 6 (lote_t_375)
1. Leia C:/winegod-app/lotes_codex/lote_t_375.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_375.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 7 (lote_t_376)
1. Leia C:/winegod-app/lotes_codex/lote_t_376.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_376.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 8 (lote_t_377)
1. Leia C:/winegod-app/lotes_codex/lote_t_377.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_377.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 9 (lote_t_378)
1. Leia C:/winegod-app/lotes_codex/lote_t_378.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_378.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 10 (lote_t_379)
1. Leia C:/winegod-app/lotes_codex/lote_t_379.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_379.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
