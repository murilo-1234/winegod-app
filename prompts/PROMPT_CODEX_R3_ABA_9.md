...
### LOTE 1 (lote_t_380)
1. Leia C:/winegod-app/lotes_codex/lote_t_380.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_380.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 2 (lote_t_381)
1. Leia C:/winegod-app/lotes_codex/lote_t_381.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_381.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 3 (lote_t_382)
1. Leia C:/winegod-app/lotes_codex/lote_t_382.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_382.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 4 (lote_t_383)
1. Leia C:/winegod-app/lotes_codex/lote_t_383.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_383.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 5 (lote_t_384)
1. Leia C:/winegod-app/lotes_codex/lote_t_384.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_384.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 6 (lote_t_385)
1. Leia C:/winegod-app/lotes_codex/lote_t_385.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_385.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 7 (lote_t_386)
1. Leia C:/winegod-app/lotes_codex/lote_t_386.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_386.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 8 (lote_t_387)
1. Leia C:/winegod-app/lotes_codex/lote_t_387.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_387.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 9 (lote_t_388)
1. Leia C:/winegod-app/lotes_codex/lote_t_388.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_388.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 10 (lote_t_389)
1. Leia C:/winegod-app/lotes_codex/lote_t_389.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_389.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
