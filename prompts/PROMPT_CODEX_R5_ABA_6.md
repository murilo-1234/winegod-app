...
### LOTE 1 (lote_t_550)
1. Leia C:/winegod-app/lotes_codex/lote_t_550.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_550.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 2 (lote_t_551)
1. Leia C:/winegod-app/lotes_codex/lote_t_551.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_551.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 3 (lote_t_552)
1. Leia C:/winegod-app/lotes_codex/lote_t_552.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_552.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 4 (lote_t_553)
1. Leia C:/winegod-app/lotes_codex/lote_t_553.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_553.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 5 (lote_t_554)
1. Leia C:/winegod-app/lotes_codex/lote_t_554.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_554.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 6 (lote_t_555)
1. Leia C:/winegod-app/lotes_codex/lote_t_555.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_555.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 7 (lote_t_556)
1. Leia C:/winegod-app/lotes_codex/lote_t_556.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_556.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 8 (lote_t_557)
1. Leia C:/winegod-app/lotes_codex/lote_t_557.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_557.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 9 (lote_t_558)
1. Leia C:/winegod-app/lotes_codex/lote_t_558.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_558.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 10 (lote_t_559)
1. Leia C:/winegod-app/lotes_codex/lote_t_559.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_t_559.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
