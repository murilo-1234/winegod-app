...
### LOTE 8 (lote_r_1575)
1. Leia C:/winegod-app/lotes_codex/lote_r_1575.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1575.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 9 (lote_r_1576)
1. Leia C:/winegod-app/lotes_codex/lote_r_1576.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1576.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 10 (lote_r_1577)
1. Leia C:/winegod-app/lotes_codex/lote_r_1577.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1577.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 11 (lote_r_1578)
1. Leia C:/winegod-app/lotes_codex/lote_r_1578.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1578.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 12 (lote_r_1579)
1. Leia C:/winegod-app/lotes_codex/lote_r_1579.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1579.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 13 (lote_r_1580)
1. Leia C:/winegod-app/lotes_codex/lote_r_1580.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1580.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 14 (lote_r_1581)
1. Leia C:/winegod-app/lotes_codex/lote_r_1581.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1581.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 15 (lote_r_1582)
1. Leia C:/winegod-app/lotes_codex/lote_r_1582.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1582.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 16 (lote_r_1583)
1. Leia C:/winegod-app/lotes_codex/lote_r_1583.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1583.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 17 (lote_r_1584)
1. Leia C:/winegod-app/lotes_codex/lote_r_1584.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1584.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 18 (lote_r_1585)
1. Leia C:/winegod-app/lotes_codex/lote_r_1585.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1585.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 19 (lote_r_1586)
1. Leia C:/winegod-app/lotes_codex/lote_r_1586.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1586.txt
3. NAO copie de outros arquivos. Classifique do ZERO.

### LOTE 20 (lote_r_1587)
1. Leia C:/winegod-app/lotes_codex/lote_r_1587.txt (os itens numerados)
2. Classifique em blocos de 250, salve em C:/winegod-app/lotes_codex/resposta_r_1587.txt
3. NAO copie de outros arquivos. Classifique do ZERO.
