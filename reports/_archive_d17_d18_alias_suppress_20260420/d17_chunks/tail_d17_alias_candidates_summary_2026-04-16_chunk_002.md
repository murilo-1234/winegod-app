...
Data: 2026-04-17 03:33:13
Modo: read-only contra Render; sem INSERT em `wine_aliases`

## Resultado curto

- Candidatos D17 validados: `4.560`
- `ALIAS_AUTO`: `4.316`
- `ALIAS_QA`: `244`
- QA pack humano: `241` linhas
- Runtime: `712s`

## Artefatos

- Full rowset: `C:\winegod-app\reports\tail_d17_alias_candidates_2026-04-16_chunk_002.csv.gz`
- QA CSV: `C:\winegod-app\reports\tail_d17_alias_qa_pack_2026-04-16_chunk_002.csv`

## Contagem por lane

| lane | candidatos | qa_sample |
| --- | --- | --- |
| ALIAS_AUTO | 4.316 | 216 |
| ALIAS_QA | 244 | 25 |
...
| estrato | candidatos |
| --- | --- |
| S6_GENERAL_REMAINDER | 3.885 |
| S5_SOURCE_RICH_STRUCTURED | 360 |
| S4_MULTI_CLEAN_OR_AMBIG_LINEAGE | 213 |
| S2_NO_SOURCE | 79 |
| S3_NO_LINEAGE_OR_ORPHAN | 23 |

## Evidencia principal

| evidencia | candidatos |
| --- | --- |
| strong_name_token_overlap>=2 | 2.143 |
| strong_name_and_producer_overlap | 1.983 |
| name_and_source_to_canonical_producer | 161 |
| stripped_name | 131 |
| exact_name | 62 |
| y2_plus_text_evidence | 56 |
| broad_name_with_strong_producer | 24 |
...
| motivo | ocorrencias |
| --- | --- |
| producer_incompatible | 8.220.649 |
| tipo_mismatch | 1.176.753 |
| weak_single_token_or_no_text_evidence | 129.352 |
| no_scored_candidate | 24.099 |
| no_candidate_pool | 14.168 |
| score_below_030 | 11.347 |
| s6_medium_excluded_for_d19 | 4.880 |
| s6_auto_floor_weak_evidence | 856 |
| s6_auto_floor_weak_name_anchor | 567 |
| s6_auto_floor_no_producer_anchor | 541 |
| score_gap_below_d17 | 329 |
