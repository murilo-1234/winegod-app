...
Data: 2026-04-17 04:20:29
Modo: read-only contra Render; sem INSERT em `wine_aliases`

## Resultado curto

- Candidatos D17 validados: `5.305`
- `ALIAS_AUTO`: `5.073`
- `ALIAS_QA`: `232`
- QA pack humano: `278` linhas
- Runtime: `516s`

## Artefatos

- Full rowset: `C:\winegod-app\reports\tail_d17_alias_candidates_2026-04-16_chunk_007.csv.gz`
- QA CSV: `C:\winegod-app\reports\tail_d17_alias_qa_pack_2026-04-16_chunk_007.csv`

## Contagem por lane

| lane | candidatos | qa_sample |
| --- | --- | --- |
| ALIAS_AUTO | 5.073 | 254 |
| ALIAS_QA | 232 | 24 |
...
| estrato | candidatos |
| --- | --- |
| S6_GENERAL_REMAINDER | 4.508 |
| S5_SOURCE_RICH_STRUCTURED | 418 |
| S4_MULTI_CLEAN_OR_AMBIG_LINEAGE | 280 |
| S2_NO_SOURCE | 56 |
| S3_NO_LINEAGE_OR_ORPHAN | 43 |

## Evidencia principal

| evidencia | candidatos |
| --- | --- |
| strong_name_token_overlap>=2 | 2.948 |
| strong_name_and_producer_overlap | 1.983 |
| name_and_source_to_canonical_producer | 115 |
| stripped_name | 101 |
| exact_name | 65 |
| y2_plus_text_evidence | 53 |
| broad_name_with_strong_producer | 40 |
...
| motivo | ocorrencias |
| --- | --- |
| producer_incompatible | 3.099.743 |
| tipo_mismatch | 394.317 |
| weak_single_token_or_no_text_evidence | 62.012 |
| no_candidate_pool | 20.540 |
| no_scored_candidate | 18.187 |
| score_below_030 | 7.162 |
| s6_medium_excluded_for_d19 | 4.451 |
| s6_auto_floor_weak_name_anchor | 651 |
| score_gap_below_d17 | 375 |
| s6_auto_floor_weak_evidence | 308 |
| s6_auto_floor_no_producer_anchor | 183 |
