...
Data: 2026-04-17 04:51:48
Modo: read-only contra Render; sem INSERT em `wine_aliases`

## Resultado curto

- Candidatos D17 validados: `4.073`
- `ALIAS_AUTO`: `3.923`
- `ALIAS_QA`: `150`
- QA pack humano: `212` linhas
- Runtime: `610s`

## Artefatos

- Full rowset: `C:\winegod-app\reports\tail_d17_alias_candidates_2026-04-16_chunk_010.csv.gz`
- QA CSV: `C:\winegod-app\reports\tail_d17_alias_qa_pack_2026-04-16_chunk_010.csv`

## Contagem por lane

| lane | candidatos | qa_sample |
| --- | --- | --- |
| ALIAS_AUTO | 3.923 | 197 |
| ALIAS_QA | 150 | 15 |
...
| estrato | candidatos |
| --- | --- |
| S6_GENERAL_REMAINDER | 3.588 |
| S4_MULTI_CLEAN_OR_AMBIG_LINEAGE | 277 |
| S5_SOURCE_RICH_STRUCTURED | 146 |
| S2_NO_SOURCE | 43 |
| S3_NO_LINEAGE_OR_ORPHAN | 19 |

## Evidencia principal

| evidencia | candidatos |
| --- | --- |
| strong_name_token_overlap>=2 | 1.901 |
| strong_name_and_producer_overlap | 1.791 |
| stripped_name | 232 |
| exact_name | 64 |
| y2_plus_text_evidence | 36 |
| broad_name_with_strong_producer | 28 |
| name_and_source_to_canonical_producer | 21 |
...
| motivo | ocorrencias |
| --- | --- |
| producer_incompatible | 1.975.154 |
| tipo_mismatch | 314.226 |
| weak_single_token_or_no_text_evidence | 46.802 |
| no_candidate_pool | 23.363 |
| no_scored_candidate | 18.483 |
| score_below_030 | 6.084 |
| s6_medium_excluded_for_d19 | 3.144 |
| s6_auto_floor_weak_name_anchor | 626 |
| score_gap_below_d17 | 191 |
| s6_auto_floor_weak_evidence | 80 |
| s6_auto_floor_no_producer_anchor | 40 |
