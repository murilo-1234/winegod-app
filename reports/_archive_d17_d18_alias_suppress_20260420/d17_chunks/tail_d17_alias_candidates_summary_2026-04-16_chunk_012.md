...
Data: 2026-04-17 05:16:58
Modo: read-only contra Render; sem INSERT em `wine_aliases`

## Resultado curto

- Candidatos D17 validados: `5.174`
- `ALIAS_AUTO`: `4.962`
- `ALIAS_QA`: `212`
- QA pack humano: `271` linhas
- Runtime: `908s`

## Artefatos

- Full rowset: `C:\winegod-app\reports\tail_d17_alias_candidates_2026-04-16_chunk_012.csv.gz`
- QA CSV: `C:\winegod-app\reports\tail_d17_alias_qa_pack_2026-04-16_chunk_012.csv`

## Contagem por lane

| lane | candidatos | qa_sample |
| --- | --- | --- |
| ALIAS_AUTO | 4.962 | 249 |
| ALIAS_QA | 212 | 22 |
...
| estrato | candidatos |
| --- | --- |
| S6_GENERAL_REMAINDER | 4.500 |
| S4_MULTI_CLEAN_OR_AMBIG_LINEAGE | 316 |
| S5_SOURCE_RICH_STRUCTURED | 277 |
| S2_NO_SOURCE | 59 |
...
| --- | --- |
| strong_name_token_overlap>=2 | 2.604 |
| strong_name_and_producer_overlap | 2.222 |
| name_and_source_to_canonical_producer | 100 |
| stripped_name | 91 |
| exact_name | 75 |
| y2_plus_text_evidence | 55 |
| broad_name_with_strong_producer | 27 |
...
| motivo | ocorrencias |
| --- | --- |
| producer_incompatible | 2.946.191 |
| tipo_mismatch | 463.661 |
| weak_single_token_or_no_text_evidence | 53.524 |
| no_candidate_pool | 21.484 |
| no_scored_candidate | 18.189 |
| score_below_030 | 4.088 |
| s6_medium_excluded_for_d19 | 3.745 |
| s6_auto_floor_weak_name_anchor | 549 |
| s6_auto_floor_weak_evidence | 357 |
| score_gap_below_d17 | 276 |
| s6_auto_floor_no_producer_anchor | 226 |
