"""CLI Tier2 global (semanal, Playwright+IA, pais != br).

Gera JSONL + summary em `reports/data_ops_artifacts/tier2_global/`.
Read-only. Nao aplica. Retorna exit=2 com `no_producer_tier2_global`
se o `lojas_scraping` nao tiver lojas Tier2 (playwright_ia).
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Exporter Tier2 global (Playwright+IA).")
