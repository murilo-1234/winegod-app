"""
Wine Classifier — Chrome (12 abas).
4 Mistral + 4 Gemini Rapido + 4 Grok Expert.
...
from wine_classifier.drivers import MistralDriver, GeminiRapidoDriver, GrokDriver
...
def main():
    log("=" * 60)
    log("  WINE CLASSIFIER — Chrome (Mistral + Gemini + Grok)")
